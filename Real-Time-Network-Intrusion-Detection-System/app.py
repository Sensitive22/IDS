...
from capture import capture_packets, stop_capture, flow_data
...
app.secret_key = 'WgCOiNaVPLBq'  # Set this to a secure key

# MySQL Configuration (XAMPP)
app.config['MYSQL_HOST'] = 'mysqldb-bhogalerushikesh3-d033.f.aivencloud.com'
app.config['MYSQL_PORT'] = 24332
app.config['MYSQL_USER'] = 'avnadmin'
app.config['MYSQL_PASSWORD'] = 'AVNS_2vgyZRAWzJgOH0itgGs'  # Default password for XAMPP
